                ...
                <div class="card">
                    ...
                    <form id="regForm" class="" action="{{ route('store_checkout') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                        ...
                        <div class="tab">
                            ...
                            <input name="room_booking_id" value="{{ $checkout_hotel->id }}"  style="display: none; opacity: 0;">
                            <div class="form-group row">
                                <label for="start_date" class="col-md-4 col-form-label text-md-left">Date/Start Date:</label>
                                <div class="col-md-6">
                                    <input class="form-control" id="check_in_date" name="h_start_date" value="{{ $checkout_hotel->start_date }}" autocomplete="off" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" id="check_out_date" value="{{ $checkout_hotel->end_date }}" name="h_end_date" autocomplete="off" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" value="{{ $checkout_hotel->guest_name }}" id="name" name="name" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" id="contact_no" value="{{ $checkout_hotel->guest_contact }}" name="contact" required readonly>
                                </div>
                            </div>

                            @foreach($rooms as $room)
                                @if($room->id == $checkout_hotel->room_id)
                                    <div class="form-group row">
                                        <label for="room_no" class="col-md-4 col-form-label text-md-left">Room No:</label>
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" id="room_no" value="{{ $room->room_no }}" name="room_no" required readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            @foreach($hotel_bill as $bill)
                                @if($bill->booking_id == $checkout_hotel->id)
                                    <div class="form-group row">
                                        <label for="contact_no" class="col-md-4 col-form-label text-md-left">Total Day:</label>
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" id="hotel_bill" value="{{ $bill->total_day }}" name="h_total_day" required readonly>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                                ...
                                <div class="col-md-6">
                                    @foreach($hotel_bill as $bill)
                                        @if($bill->booking_id == $checkout_hotel->id)
                                            ...
                                            <input type="number" class="form-control" id="hotel_bill" value="{{ $bill->total_pay }}" name="h_total_bill" required readonly>
                                        @endif
                                    @endforeach
                                        <p class="error_billing"><b>Warning!</b> Hotel Billing is not Complete <a href="{{ URL::to('makebilling',$checkout_hotel->id) }}">Go for billings</a></p>
                                </div>
                            </div>
                        </div>

                        @foreach($venue_bookings as $value)
                                @if($checkout_hotel->venue_booking_id == $value->id || ($value->room_booking_id == $checkout_hotel->id) )
                                        <div class="tab">
                                            ...
                                            <div class="form-group row">
                                                <label for="start_date" class="col-md-4 col-form-label text-md-left">Date/Start Date:</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" id="check_in_date" name="v_start_date" value="{{ $value->start_date }}" autocomplete="off" required readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="end_date" class="col-md-4 col-form-label text-md-left">End Date:</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" id="check_out_date" value="{{ $value->end_date }}" name="v_end_date" autocomplete="off" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="name" class="col-md-4 col-form-label text-md-left">Name:</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="{{ $value->name }}" id="name" name="name" required readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="contact_no" class="col-md-4 col-form-label text-md-left">Contact No:</label>
                                                <div class="col-md-6">
                                                    <input type="number" class="form-control" id="contact_no" value="{{ $value->contact_no }}" name="contact" required readonly>
                                                </div>
                                            </div>

                                            @foreach($venues as $venue)
                                                @if($venue->id == $value->venue_id)
                                                    <div class="form-group row">
                                            ...
                                            @foreach($venue_bill as $bill)
                                                @if($bill->venue_booking_id == $value->id)
                                                    <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    @foreach($venue_bill as $bill)
                                                        @if($bill->venue_booking_id == $value->id)
                                                          ...
                                                          <input type="text" class="form-control" name="v_total_bill" value="{{ $bill->total_pay }}" readonly>
                                                        @endif
                                                    @endforeach
                                                        <p class="error_venue_billing" style="color: #f00;"><b>Warning!</b> Venue Billing is not Complete <a href="{{ URL::to('training/makebilling',$value->id) }}">Go for billings</a></p>
                                                </div>
                                            </div>
                                        </div>
                                @endif
                        ...
                        <div class="tab">
                            <h1 class="mb-5">Restaurant Bill</h1>
                                <table class="table">
                                    ...
                                    <tbody>
                                    @foreach($restaurant_bill as $key => $bill)
                                        ...
                                        $total = $price*$quantity;
                                         ?>
                                        @if($bill->guest_id == $checkout_hotel->id && $bill->menu_id == $menu->id && $bill->booking_status == 1)
                                        <tr>
                                        ...
                                        @foreach($venue_bookings as $value)
                                            @if($menu->id == $bill->menu_id)
                                                @if($checkout_hotel->venue_booking_id == $value->id && $bill->guest_id == $value->id  && $bill->booking_status == 2 || ($value->room_booking_id == $checkout_hotel->id && $bill->guest_id == $value->id  && $bill->booking_status == 2) )
                                                   <tr>
                                                        <td>{{ $bill->created_at }}</td>
                                                        <td>{{ $menu->name }}</td>
                                                        <td>
                                                        ...
                                                        <td>{{ $menu->price }}</td>
                                                        <td>
                                                           <input class="credit" value="{{ $total }}" type="number" readonly>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endif
                            ...
                            <input class="pull-right" type="number" id="total-credit" name="r_total_bill" readonly style="border: 0; margin-right: 33px;">
                        </div>
                        ...
                        <div class="tab">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="all" value="" name="all_total" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
