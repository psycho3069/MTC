...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"> <big> <strong>ADD NEW SALARY GRADE</strong> </big> </div>
              ...
              <!--form-->
              <form class="" action="{{ url('/save_salary_grade') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                @csrf    
                ...
                <div class="form-group row">
                  <label for="type" class="col-md-4 col-form-label text-md-left">Type: <span class="required">*</span></label>
                  <div class="col-md-6">
                    <select id="type" name="type" class="form-control" required>
                      <option value>--Choose One--</option>
                      <option value="1">{{Config::get('constants.hrSalaryGradeType.1')}}</option>
                      <option value="2">{{Config::get('constants.hrSalaryGradeType.2')}}</option>
                    </select>
                  </div>
                </div>

                <div class="form-group row">
                    <label for="provident_fund" class="col-md-4 col-form-label text-md-left">Provident Fund: <span class="required">*</span></label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" id="provident_fund" name="provident_fund" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                    <input type="text" class="form-control" id="transportation_allowance" name="transportation_allowance">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control" id="dinning_allowance" name="dinning_allowance">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                    <input type="text" class="form-control" id="home_rent" name="home_rent">
                  </div>
                </div>
