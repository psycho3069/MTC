...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"> <big> <strong>ADD NEW INVENTORY SUPPLIER</strong> </big> </div>
              ...
              <!--form-->
              <form class="" action="{{ url('/save_inventory_supplier') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                @csrf
