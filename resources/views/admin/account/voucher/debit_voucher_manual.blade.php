        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header row">
                  ...
                  <div class="col-md-6">
                    <strong><big>Debit Voucher</big></strong>
                  </div>
                ...
                <form class="" action="{{ url('/save_debit_manual') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                  @csrf
                  ...
                  <p class="alert-success" style="font-size: 20px; color: white; background:#149278; padding: 0 30px 0 30px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                          <label for="debit_amount" class="col-md-6 col-form-label text-md-left">Debit Amount</label>
                          <div class="col-md-6">
