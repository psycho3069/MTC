...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><big> <strong>SUPPLIERS</strong> </big></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <a href="{{URL::to('/restaurant/supplier/add_supplier')}}" class="btn btn-primary">Add New Supplier</a>
                </div>
                ...
                <div class="table-responsive">
                    <table id="suppliers" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        @foreach($supplier_info as $key => $supplier)
                            <tr>
                                <td width="5%">{{ ++$key }}</td>
                                <td>{{$supplier->name}}</td>
